/**
 * Central Papido Service Areas Configuration (Frontend)
...
export const PAPIDO_SERVICE_AREAS = {
 ...
 */
export function isInsideServiceArea(lat, lng, areaKey) {
 ...
 */
export function classifyLocationArea(lat, lng) {
 ...
 */
export function validateRideServiceAreas(pickup, destination) {
