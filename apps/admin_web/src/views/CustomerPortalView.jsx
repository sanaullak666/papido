  ...
  return (
    <div className="theme-orange-beige" style={{ minHeight: '100vh', background: '#FAF5EE', color: '#271E16', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ background: '#FFFFFF', border: '1.5px solid #E8DCCB', borderRadius: '16px', padding: '24px', boxShadow: '0 10px 30px rgba(234, 88, 12, 0.08)', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              {!activeRide && (
                <>
                  ...
                  {/* Rapido Style Service Options List */}
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2px' }}>
                      <span style={{ fontSize: '13px', fontWeight: 800, color: '#1F1A16' }}>Select Ride Option</span>
                      <span style={{ fontSize: '11px', color: '#EA580C', fontWeight: 800, background: '#FFF7ED', padding: '2px 8px', borderRadius: '6px', border: '1px solid #FED7AA' }}>
                        Flat ₹25 across campus
                      </span>
                    </div>
                    ...
                    <div
                      ...
                      onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') setVehicleType('BIKE'); }}
                      style={{
                        padding: '12px 16px',
                        borderRadius: '16px',
                        border: vehicleType === 'BIKE' ? '2px solid #F97316' : '1.5px solid #EFE4D6',
                        background: vehicleType === 'BIKE' ? '#FFF7ED' : '#FFFFFF',
                        boxShadow: vehicleType === 'BIKE' ? '0 4px 14px rgba(249, 115, 22, 0.15)' : '0 1px 3px rgba(0,0,0,0.03)',
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'space-between',
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                        ...
                        <div>
                          <div style={{ fontWeight: 800, fontSize: '15px', color: '#1F1A16', display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <span>Bike</span>
                            {vehicleType === 'BIKE' && (
                              <span style={{ background: '#059669', color: '#FFFFFF', fontSize: '9px', fontWeight: 900, padding: '1px 6px', borderRadius: '9999px' }}>
                                SELECTED
                              </span>
                            )}
                          </div>
                          <div style={{ fontSize: '12px', color: '#796D61', fontWeight: 600, marginTop: '2px' }}>
                            2 min away • Fastest campus pickup
                          </div>
                        </div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ fontSize: '20px', fontWeight: 900, color: '#1F1A16' }}>
                          ₹{fareEstimate?.estimatedFare || (isDoubleRide ? 40 : 25)}
                        </div>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') setVehicleType('SCOOTER'); }}
                      style={{
                        padding: '12px 16px',
                        borderRadius: '16px',
                        border: vehicleType === 'SCOOTER' ? '2px solid #F97316' : '1.5px solid #EFE4D6',
                        background: vehicleType === 'SCOOTER' ? '#FFF7ED' : '#FFFFFF',
                        boxShadow: vehicleType === 'SCOOTER' ? '0 4px 14px rgba(249, 115, 22, 0.15)' : '0 1px 3px rgba(0,0,0,0.03)',
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'space-between',
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '12px', color: '#796D61', fontWeight: 600, marginTop: '2px' }}>
                            3 min away • Smooth &amp; comfortable ride
                          </div>
                        </div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                    ...
                    {/* 3. Any 2-Wheeler / Peer Match (from Figma!) */}
                    <div
                      role="button"
                      tabIndex={0}
                      onClick={() => setVehicleType('ANY')}
                      onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') setVehicleType('ANY'); }}
                      style={{
                        padding: '12px 16px',
                        borderRadius: '16px',
                        border: vehicleType === 'ANY' ? '2px solid #F97316' : '1.5px solid #EFE4D6',
                        background: vehicleType === 'ANY' ? '#FFF7ED' : '#FFFFFF',
                        boxShadow: vehicleType === 'ANY' ? '0 4px 14px rgba(249, 115, 22, 0.15)' : '0 1px 3px rgba(0,0,0,0.03)',
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'space-between',
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                        ...
                        <div>
                          <div style={{ fontWeight: 800, fontSize: '15px', color: '#1F1A16', display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <span>Any 2-Wheeler</span>
                            <span style={{ background: '#EA580C', color: '#FFFFFF', fontSize: '9px', fontWeight: 900, padding: '1px 6px', borderRadius: '9999px' }}>
                              FAST MATCH
                            </span>
                          </div>
                          <div style={{ fontSize: '12px', color: '#796D61', fontWeight: 600, marginTop: '2px' }}>
                            Instant match • Nearest active rider
                          </div>
                        </div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                  ...
                  {/* Rapido Style Unlimited Discounts / Campus Pass Ribbon */}
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      <span style={{ fontSize: '12px', fontWeight: 800, color: '#9A3412' }}>
                        <strong>UNLIMITED</strong> Discounts! Campus Flat Fare: ₹25 across PU
                      </span>
                    </div>
                  ...
                  {/* Rapido Style Payment & Offers Row */}
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                    <div style={{
                      ...
                      <span style={{ color: '#796D61', fontSize: '11px' }}>&gt;</span>
                    </div>
                  ...
                  {scheduledRides && scheduledRides.length > 0 && (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#1E40AF', fontWeight: 800, fontSize: '13px' }}>
                        <Calendar size={16} />
                        <span>You have {scheduledRides.length} pre-booked {scheduledRides.length === 1 ? 'trip' : 'trips'} scheduled</span>
                      </div>
                      <span style={{ fontSize: '11px', color: '#2563EB', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '4px' }}>
              ...
              {activeRide && (
                activeRide.status === 'COMPLETED' ? (
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    {/* Customer Fare Card (Rapido Clean Style) */}
                    <div style={{
                      background: 'linear-gradient(135deg, #FFF7ED, #FEF3C7)',
                      border: '1.5px solid #FDBA74',
                      borderRadius: '16px',
                      ...
                      <div>
                        <div style={{ fontSize: '11px', color: '#9A3412', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px' }}>FARE TO PAY AT DROP:</div>
                        <div style={{ fontSize: '28px', fontWeight: 900, color: '#EA580C', letterSpacing: '-0.02em' }}>
                      ...
                      <div style={{ textAlign: 'right' }}>
                        <span style={{
                          ...
                          {activeRide.payment_method || 'CASH / UPI'} ON DROP
                        </span>
                        {activeRide.is_double_ride ? (
                          <div style={{ fontSize: '11px', color: '#059669', marginTop: '6px', fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '4px' }}>
                            <Users size={12} /> Double Ride (Discounted)
                          </div>
                        ) : null}
                      </div>
                    </div>

                    {/* Rapido 4-Digit Ride OTP Highlight (4 Separate Digit Boxes) */}
                    {['ACCEPTED', 'RIDER_ARRIVING', 'RIDER_REACHED'].includes(activeRide.status) && (activeRide.otp || activeRide.otp_code) && (
                      <div style={{
                        ...
                        <div style={{ fontSize: '11.5px', fontWeight: 900, color: '#C2410C', textTransform: 'uppercase', letterSpacing: '0.8px', marginBottom: '8px' }}>
                          START OTP • Share with Captain Upon Arrival
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'center', gap: '10px', margin: '8px 0' }}>
                          {String(activeRide.otp || activeRide.otp_code || '----').padEnd(4, '-').slice(0, 4).split('').map((digit, idx) => (
                            <div key={idx} style={{
                              width: '52px',
                              height: '60px',
                              borderRadius: '14px',
                        ...
                        <div style={{ fontSize: '11px', color: '#796D61', fontWeight: 600, marginTop: '6px' }}>
                          Only share after meeting your rider and verifying the vehicle
                        </div>
                      </div>
                    )}

                    {/* Assigned Rider / Captain Card (Rapido Style) */}
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            <div>
                              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                                <div style={{ fontWeight: 800, fontSize: '16px', color: '#1F1A16' }}>{activeRide.rider_name}</div>
                              ...
                              {!(activeRide.rider_is_core || activeRide.is_core_member) && (
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '3px' }}>
                                  <span style={{
                                    ...
                                    {activeRide.rider_vehicle_number || activeRide.vehicle_number || 'PY 01 AB 1234'}
                                  </span>
                                  <span style={{ fontSize: '11.5px', color: '#796D61' }}>
                                    {activeRide.rider_vehicle_model || activeRide.vehicle_model || 'Campus 2-Wheeler'}
                                  </span>
                                </div>
                              )}
                            </div>
        ...
        {/* ============================================================ */}
        {/* TAB 1B: PRE-BOOKED SCHEDULED RIDES MANAGER */}
        {/* ============================================================ */}
        {currentTab === 'scheduled' && (
          <div className="content-body" style={{ maxWidth: '780px', margin: '0 auto', width: '100%', padding: '24px 16px' }}>
            <div style={{ background: '#FFFFFF', border: '1.5px solid #E8DCCB', borderRadius: '16px', padding: '24px', boxShadow: '0 10px 30px rgba(234, 88, 12, 0.08)' }}>
              
              {/* Header */}
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' }}>
                <div>
                  <h2 style={{ fontSize: '22px', fontWeight: 800, color: '#1C1917', margin: 0, display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <Calendar size={22} color="#EA580C" /> My Pre-Booked Campus Rides
                  </h2>
                  <p style={{ fontSize: '13px', color: '#796D61', margin: '4px 0 0 0' }}>
                    Track, manage, and view rider assignments for your advance bookings.
                  </p>
                </div>
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                  ...
                  >
                    <RefreshCw size={13} className={scheduledLoading ? 'spin' : ''} />
                  ...
                  <button
                    ...
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '8px 14px', fontWeight: 800 }}
                  >
                    <Clock size={13} />
              ...
              {scheduledLoading && scheduledRides.length === 0 ? (
                <div style={{ padding: '40px 20px', textAlign: 'center', color: '#796D61' }}>
                  Loading your scheduled rides...
                </div>
                ...
                <div style={{
                  ...
                  <Calendar size={36} color="#EA580C" style={{ margin: '0 auto 12px', opacity: 0.6 }} />
                  <div style={{ fontWeight: 800, fontSize: '16px', color: '#271E16' }}>
                    No upcoming pre-booked rides
                  </div>
                  <div style={{ fontSize: '13px', marginTop: '6px', maxWidth: '380px', margin: '6px auto 16px', lineHeight: '1.4' }}>
                  ...
                  <button
                    ...
                    className="btn btn-primary"
                    style={{ padding: '10px 22px', fontWeight: 800, fontSize: '14px' }}
                  >
                    Pre-Book a Ride Now
                  </button>
                </div>
                  ...
                  {scheduledRides.map((sr) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          background: '#FFFFFF',
                          border: isRiderAssigned ? '2px solid #10B981' : '1.5px solid #BFDBFE',
                          borderRadius: '14px',
                          padding: '18px',
                          boxShadow: isRiderAssigned ? '0 4px 16px rgba(16, 185, 129, 0.12)' : '0 4px 14px rgba(59, 130, 246, 0.08)',
                          display: 'flex',
                          flexDirection: 'column',
                          gap: '12px'
                        }}
                      >
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                            ...
                            {isRiderAssigned ? (
                              <span style={{ background: '#D1FAE5', color: '#065F46', padding: '3px 10px', borderRadius: '6px', fontSize: '11px', fontWeight: 800, display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                                <CheckCircle2 size={13} color="#059669" /> CONFIRMED WITH RIDER
                              </span>
                            ) : (
                              <span style={{ background: '#FEF3C7', color: '#92400E', padding: '3px 10px', borderRadius: '6px', fontSize: '11px', fontWeight: 700 }}>
                                PENDING RIDER ACCEPTANCE
                              </span>
                            )}
                          </div>
                          <div style={{ textAlign: 'right' }}>
                            <div style={{ fontSize: '11px', color: '#796D61', fontWeight: 700 }}>ESTIMATED FARE:</div>
                            <div style={{ fontSize: '18px', fontWeight: 900, color: '#EA580C' }}>
                              ₹{sr.total_fare || sr.estimated_fare || 20}
                            </div>
                          </div>
                        </div>

                        {/* Route Details */}
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', background: '#FAF5EE', padding: '12px 14px', borderRadius: '10px', fontSize: '13px' }}>
                          ...
                          <div style={{ fontSize: '11px', color: '#796D61', marginTop: '2px', borderTop: '1px dashed #E8DCCB', paddingTop: '6px' }}>
                        ...
                        {isRiderAssigned ? (
                          <div style={{
                            ...
                            <div>
                              <div style={{ fontSize: '10px', color: '#047857', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                          ...
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px', background: '#FFFBEB', border: '1px solid #FDE68A', padding: '12px 14px', borderRadius: '10px' }}>
